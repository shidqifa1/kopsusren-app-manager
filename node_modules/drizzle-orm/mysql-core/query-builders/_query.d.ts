...
declare class _RelationalQueryBuilder<TPreparedQueryHKT extends PreparedQueryHKTBase, TSchema extends V1.TablesRelationalConfig, TFields extends V1.TableRelationalConfig> {
  ...
  findMany<TConfig extends V1.DBQueryConfigWithComment<'many', true, TSchema, TFields>>(config?: KnownKeysOnly<TConfig, V1.DBQueryConfigWithComment<'many', true, TSchema, TFields>> & {
...
declare class MySqlRelationalQuery<TPreparedQueryHKT extends PreparedQueryHKTBase, TResult> extends QueryPromise<TResult> {
  ...
  constructor(fullSchema: Record<string, unknown>, schema: V1.TablesRelationalConfig, tableNamesMap: Record<string, string>, table: MySqlTable, tableConfig: V1.TableRelationalConfig, dialect: MySqlDialect, session: MySqlSession, config: V1.DBQueryConfigWithComment<'many', true> | true, queryMode: 'many' | 'first', mode?: Mode | undefined);
