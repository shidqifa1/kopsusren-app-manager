...
var MySqlDatabase = class {
	...
	constructor(dialect, session, relations, schema, mode) {
		...
		this._query = {};
		if (this._.schema) for (const [tableName, columns] of Object.entries(this._.schema)) this._query[tableName] = new _RelationalQueryBuilder(schema.fullSchema, this._.schema, this._.tableNamesMap, schema.fullSchema[tableName], columns, dialect, session, this.mode);
		this.query = {};
