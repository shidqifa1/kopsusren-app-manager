...
var PglitePreparedQuery = class extends PgAsyncPreparedQuery {
	...
	async execute(placeholderValues = {}) {
		...
		if (!fields && !customResultMapper) return this.queryWithCache(query.sql, params, async () => {
			return await client.query(query.sql, params, rawQueryConfig);
		});
		const result = await this.queryWithCache(query.sql, params, async () => {
			return await client.query(query.sql, params, queryConfig);
		});
	...
	async executeRqbV2(placeholderValues = {}) {
		...
		return customResultMapper((await client.query(query.sql, params, rawQueryConfig)).rows);
	}
	all(placeholderValues = {}) {
		const params = fillPlaceholders(this.query.params, placeholderValues);
		this.logger.logQuery(this.query.sql, params);
		return this.queryWithCache(this.query.sql, params, async () => {
			return await this.client.query(this.query.sql, params, this.rawQueryConfig);
...
var PgliteSession = class PgliteSession extends PgAsyncSession {
	...
	prepareQuery(query, fields, name, isResponseInArrayMode, customResultMapper, queryMetadata, cacheConfig) {
		return new PglitePreparedQuery(this.client, query, this.logger, this.cache, queryMetadata, cacheConfig, fields, name, isResponseInArrayMode, customResultMapper);
	}
	prepareRelationalQuery(query, fields, name, customResultMapper) {
		return new PglitePreparedQuery(this.client, query, this.logger, this.cache, void 0, void 0, fields, name, false, customResultMapper, true);
	}
