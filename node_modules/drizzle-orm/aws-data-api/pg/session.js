...
var AwsDataApiPreparedQuery = class extends PgAsyncPreparedQuery {
	...
	constructor(client, query, options, cache, queryMetadata, cacheConfig, fields, transactionId, _isResponseInArrayMode, customResultMapper, isRqbV2Query) {
...
var AwsDataApiSession = class AwsDataApiSession extends PgAsyncSession {
	...
	prepareQuery(query, fields, name, isResponseInArrayMode, customResultMapper, queryMetadata, cacheConfig, transactionId) {
		return new AwsDataApiPreparedQuery(this.client, query, this.options, this.cache, queryMetadata, cacheConfig, fields, transactionId ?? this.transactionId, isResponseInArrayMode, customResultMapper);
	}
	prepareRelationalQuery(query, fields, name, customResultMapper, transactionId) {
		return new AwsDataApiPreparedQuery(this.client, query, this.options, this.cache, void 0, void 0, fields, transactionId ?? this.transactionId, false, customResultMapper, true);
	}
	execute(query) {
