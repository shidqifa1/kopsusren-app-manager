...
var PgRelationalQuery = class extends QueryPromise {
	...
	_prepare(name, generateName = false) {
		return tracer.startActiveSpan("drizzle.prepareQuery", () => {
			...
			return this.session.prepareRelationalQuery(builtQuery, void 0, name ?? (generateName ? preparedStatementName(builtQuery.sql, builtQuery.params) : name), (rows, mapColumnValue) => {
