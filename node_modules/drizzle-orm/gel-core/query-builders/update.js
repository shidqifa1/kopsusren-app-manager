...
var GelUpdateBuilder = class {
	...
	set(values) {
		return new GelUpdateBase(this.table, mapUpdateSet(this.table, values), this.session, this.dialect, this.withList);
	}
};
var GelUpdateBase = class extends QueryPromise {
	...
	getTableLikeFields(table) {
		if (is(table, GelTable)) return table[Table.Symbol.Columns];
...
//#endregion
export { GelUpdateBase, GelUpdateBuilder };
