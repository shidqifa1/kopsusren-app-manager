...
let __gel_core_dialect_ts = require("../dialect.cjs");

//#region src/gel-core/query-builders/query-builder.ts
var QueryBuilder = class {
	static [__entity_ts.entityKind] = "GelQueryBuilder";
	dialect;
	dialectConfig;
	constructor(dialect) {
		this.dialect = (0, __entity_ts.is)(dialect, __gel_core_dialect_ts.GelDialect) ? dialect : void 0;
		this.dialectConfig = (0, __entity_ts.is)(dialect, __gel_core_dialect_ts.GelDialect) ? void 0 : dialect;
	}
	$with(alias) {
	...
	with(...queries) {
		...
		function select(fields) {
			return new require_gel_core_query_builders_select.GelSelectBuilder({
	...
	getDialect() {
		if (!this.dialect) this.dialect = new __gel_core_dialect_ts.GelDialect(this.dialectConfig);
		return this.dialect;
	}
};
