import { AnyGelColumn } from "../columns/common.js";
import { QueryBuilder } from "./query-builder.js";
import { SelectedFieldsFlat, SelectedFieldsOrdered } from "./select.types.js";
import { GelUpdateSetSource } from "./update.js";
...
import { GelTable, TableConfig as TableConfig$1 } from "../table.js";
...
type GelInsertWithout<T extends AnyGelInsert, TDynamic extends boolean, K extends keyof T & string> = TDynamic extends true ? T : Omit<GelInsertBase<T['_']['table'], T['_']['queryResult'], T['_']['returning'], TDynamic, T['_']['excludedMethods'] | K>, T['_']['excludedMethods'] | K>;
