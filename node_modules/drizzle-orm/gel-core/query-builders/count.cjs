...
var GelCountBuilder = class GelCountBuilder extends __sql_sql_ts.SQL {
	sql;
	static [__entity_ts.entityKind] = "GelCountBuilder";
...
//#endregion
exports.GelCountBuilder = GelCountBuilder;
