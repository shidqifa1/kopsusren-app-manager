...
//#region src/gel-core/unique-constraint.ts
...
var UniqueConstraintBuilder = class {
	static [__entity_ts.entityKind] = "GelUniqueConstraintBuilder";
	/** @internal */
	columns;
	/** @internal */
...
var UniqueOnConstraintBuilder = class {
	static [__entity_ts.entityKind] = "GelUniqueOnConstraintBuilder";
	/** @internal */
	name;
	constructor(name) {
		this.name = name;
...
var UniqueConstraint = class {
	static [__entity_ts.entityKind] = "GelUniqueConstraint";
	columns;
	name;
