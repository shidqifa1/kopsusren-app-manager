...
var PrimaryKeyBuilder = class {
	static [__entity_ts.entityKind] = "GelPrimaryKeyBuilder";
	/** @internal */
	columns;
	/** @internal */
	name;
...
var PrimaryKey = class {
	static [__entity_ts.entityKind] = "GelPrimaryKey";
	columns;
	name;
	...
	getName() {
		return this.name ?? `${this.table[require_gel_core_table.GelTable.Symbol.Name]}_${this.columns.map((column) => column.name).join("_")}_pk`;
	}
};
