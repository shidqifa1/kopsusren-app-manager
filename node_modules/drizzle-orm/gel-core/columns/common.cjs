...
let __gel_core_foreign_keys_ts = require("../foreign-keys.cjs");

//#region src/gel-core/columns/common.ts
var GelColumnBuilder = class extends __column_builder_ts.ColumnBuilder {
	foreignKeyConfigs = [];
	static [__entity_ts.entityKind] = "GelColumnBuilder";
	array(length) {
	...
	buildForeignKeys(column, table) {
		return this.foreignKeyConfigs.map(({ ref, actions }) => {
			return (0, __tracing_utils_ts.iife)((ref, actions) => {
				const builder = new __gel_core_foreign_keys_ts.ForeignKeyBuilder(() => {
...
var GelColumn = class extends __column_ts.Column {
	static [__entity_ts.entityKind] = "GelColumn";
	/** @internal */
	table;
...
var GelExtraConfigColumn = class extends GelColumn {
	static [__entity_ts.entityKind] = "GelExtraConfigColumn";
	getSQLType() {
...
var GelArrayBuilder = class extends GelColumnBuilder {
	static [__entity_ts.entityKind] = "GelArrayBuilder";
...
var GelArray = class extends GelColumn {
	static [__entity_ts.entityKind] = "GelArray";
...
//#endregion
exports.GelArray = GelArray;
exports.GelArrayBuilder = GelArrayBuilder;
exports.GelColumn = GelColumn;
exports.GelColumnBuilder = GelColumnBuilder;
exports.GelExtraConfigColumn = GelExtraConfigColumn;
