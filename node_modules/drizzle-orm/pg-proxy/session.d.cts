...
import { QueryWithTypings } from "../sql/sql.cjs";
...
declare class PreparedQuery<T extends PreparedQueryConfig, TIsRqbV2 extends boolean = false> extends PgAsyncPreparedQuery<T> {
  ...
  static readonly [entityKind]: string;
  protected query: QueryWithTypings;
  constructor(client: RemoteCallback, query: QueryWithTypings, logger: Logger, cache: Cache, queryMetadata: {
    type: 'select' | 'update' | 'delete' | 'insert';
    tables: string[];
