...
function drizzle(client, config = {}) {
	...
	const db = new ExpoSQLiteDatabase("sync", dialect, new require_expo_sqlite_session.ExpoSQLiteSession(client, dialect, relations, schema, { logger }), relations, schema);
	db.$client = client;
	return db;
}
