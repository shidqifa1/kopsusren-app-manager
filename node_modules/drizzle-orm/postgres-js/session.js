...
var PostgresJsPreparedQuery = class extends PgAsyncPreparedQuery {
...
var PostgresJsSession = class PostgresJsSession extends PgAsyncSession {
	...
	prepareQuery(query, fields, name, isResponseInArrayMode, customResultMapper, queryMetadata, cacheConfig) {
		return new PostgresJsPreparedQuery(this.client, query, this.logger, this.cache, queryMetadata, cacheConfig, fields, isResponseInArrayMode, customResultMapper);
	}
	prepareRelationalQuery(query, fields, name, customResultMapper) {
		return new PostgresJsPreparedQuery(this.client, query, this.logger, this.cache, void 0, void 0, fields, false, customResultMapper, true);
	}
	query(query, params) {
...
//#endregion
export { PostgresJsPreparedQuery, PostgresJsSession, PostgresJsTransaction };
