...
var PlanetScalePreparedQuery = class extends MySqlPreparedQuery {
	...
	async execute(placeholderValues = {}) {
		...
		const { fields, client, query, rawQueryConfig, queryConfig, joinsNotNullableMap, customResultMapper, returningIds, generatedIds } = this;
	...
	async executeRqbV2(placeholderValues = {}) {
		const params = fillPlaceholders(this.query.params, placeholderValues);
		this.logger.logQuery(this.query.sql, params);
		const { client, query, rawQueryConfig, customResultMapper } = this;
		return customResultMapper((await client.execute(query.sql, params, rawQueryConfig)).rows);
	}
...
var PlanetscaleSession = class PlanetscaleSession extends MySqlSession {
	...
	prepareQuery(query, fields, customResultMapper, generatedIds, returningIds, queryMetadata, cacheConfig) {
		return new PlanetScalePreparedQuery(this.client, query, this.logger, this.cache, queryMetadata, cacheConfig, fields, customResultMapper, generatedIds, returningIds);
	}
	prepareRelationalQuery(query, fields, customResultMapper, generatedIds, returningIds) {
		return new PlanetScalePreparedQuery(this.client, query, this.logger, this.cache, void 0, void 0, fields, customResultMapper, generatedIds, returningIds, true);
	}
...
//#endregion
export { PlanetScalePreparedQuery, PlanetScaleTransaction, PlanetscaleSession };
