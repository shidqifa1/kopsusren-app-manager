...
declare function migrate(migrations: MigrationMeta[], db: PgAsyncDatabase<PgQueryResultHKT, any, any, any>, config: string | MigrationConfig): Promise<void | MigratorInitFailResponse>;
//#endregion
