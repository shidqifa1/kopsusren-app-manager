...
const parsers = { getTypeParser: (typeId, format) => {
...
var VercelPgSession = class VercelPgSession extends __pg_core_async_session_ts.PgAsyncSession {
	...
	prepareQuery(query, fields, name, isResponseInArrayMode, customResultMapper, queryMetadata, cacheConfig) {
		return new VercelPgPreparedQuery(this.client, query, this.logger, this.cache, queryMetadata, cacheConfig, fields, name, isResponseInArrayMode, customResultMapper);
	}
	prepareRelationalQuery(query, fields, name, customResultMapper) {
		return new VercelPgPreparedQuery(this.client, query, this.logger, this.cache, void 0, void 0, fields, name, false, customResultMapper, true);
	}
