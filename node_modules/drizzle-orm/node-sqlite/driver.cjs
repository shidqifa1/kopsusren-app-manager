...
function construct(client, config = {}) {
	...
	const db = new NodeSQLiteDatabase("sync", dialect, new require_node_sqlite_session.NodeSQLiteSession(client, dialect, relations, schema, { logger }), relations, schema);
	db.$client = client;
	return db;
}
