...
import { SQL, View, noopDecoder } from "../sql/sql.js";
...
function resolveDecoder(field) {
	...
	else if (is(field, Table) || is(field, View)) return null;
	else decoder = field.getSQL().decoder;
	if (decoder.mapFromDriverValue === noopDecoder.mapFromDriverValue) return null;
...
//#endregion
export { defaultRowMapper, interpretedRowMapper, jitArrayRowMapper, jitRowMapper };
